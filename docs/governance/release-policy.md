...
- Git tags should use the canonical version name: `v2.3.0`
- Release titles should use: `v<semver> - <release name>`
- Examples:
  - `v2.3.0 - Discord Interaction System`
  - `v2.4.0 - Playback Intelligence`
  - `v2.5.0 - Multi-Source Engine`
...
- `v2.3.0 - Discord Interaction System`: current public line
- `v2.4.0 - Playback Intelligence`: `NAO IMPLEMENTADO AINDA`
- `v2.5.0 - Multi-Source Engine`: `NAO IMPLEMENTADO AINDA`
...
- playback pipeline
- Discord message surfaces, Components V2 strategy, message interaction system or visual hierarchy
